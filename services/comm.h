 ...
 * the motherfuckers hardcoded ports !!!!
 *
 */
...
{	
	...
	// On initialise des variables de type pointeur car la variable getenv renvoie un pointeur sur la zone mémoire de la virable d'environement.
	char* dp;
	char* sp;
