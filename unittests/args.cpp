...
{
    const char * argv[] = {
        "gcc", "-D", "TEST=1", "-c", "main.cpp", "-o", "main.o", 0};
    test_run("1",
             argv,
             false,
             "local:0 language:C++ compiler:gcc local:'-D, TEST=1' remote:'-c' "
             "rest:''");
}
...
{
    const char * argv[] = {
        "gcc", "-DTEST=1", "-c", "main.cpp", "-o", "main.o", 0};
    test_run("2",
             argv,
             false,
             "local:0 language:C++ compiler:gcc local:'-DTEST=1' remote:'-c' "
             "rest:''");
}
...
test_3()
{
    ...
    test_run("3",
             argv,
             false,
             "local:0 language:C++ compiler:clang local:'-D, TEST1=1, -I.' "
             "remote:'-c' rest:'-target, x86_64-unknown-linux-gnu'");
}
